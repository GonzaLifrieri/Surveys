...
function eliminarRepetidos(variable){
    variable.filter(function(elem, index, self) {
...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    ubicaciones = this.restaurantes.map(this.restaurantes.ubicacion);
    //Se crea un nuevo array donde se van a agregar las ciudades pero sin repetirse
    var ubicacionesSinRepetir = eliminarRepetidos(ubicaciones);
...
Listado.prototype.obtenerRubros = function() {
    var rubros = [];
    rubros = this.restaurantes.map(this.restaurantes.rubro);  

    var rubrosSinRepetir = eliminarRepetidos(rubros);
...
Listado.prototype.obtenerHorarios = function() {
    ...
    arregloHorarios = this.restaurantes.map(this.restaurantes.horarios);
    ...
    var arregloHorariosSinRepetir = eliminarRepetidos(arregloHorarios);

    return arregloHorariosSinRepetir.sort();
}
